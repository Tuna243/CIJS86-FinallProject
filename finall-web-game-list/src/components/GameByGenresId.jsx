    ...
    <div>
      ...
      <div className="grid grid-cols-1 grid-cols-3 lg:grid-cols-4 gap-6">
        {gameByGenreId.map((item) => (
          <div
            className="bg-gray-300 dark:bg-[#1e3a8a] p-2 rounded-lg pb-12 h-full relative cursor-pointer mt-5
          ...
          >
            ...
            />
            <h2 className="text-[20px] text-[#172554] dark:text-white font-bold">
              {item.name}
            </h2>
            <h2 className="absolute font-bold bottom-0 p-1 flex  items-center gap-2 text-gray-500 dark:text-gray-300 max-xl:">
